...
- **GOOS** significa _Go Operating System_.
...
- **GOARCH** significa _Go Architecture_.
...
_Cómo se mueve la ejecución. Go unifica muchas estructuras._
...
_Equivalente al `for` de C/Java._
...
_Se omite la inicialización y el post-expresión, quedando como un `while`._
...
_Se usa en servidores, goroutines o listeners._
...
_La variable `x` solo existe dentro del bloque `if`._
...
_Gestión de memoria y colecciones de datos._
...
_El enfoque de Go para la Orientación a Objetos._  
